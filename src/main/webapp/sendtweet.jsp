...
<html lang="en">
  ...
  <body>
	...
	<div class="card" style="width: 22rem;font-weight:bolder;color:#000;border:2px 2px 2px solid #fff !important;backgroundColor:white;">
  <div class="card-body">
    <h5 class="card-title">Tweet Count No: ${tweet.getId()}</h5>
    <h6 class="card-subtitle mb-2 text-muted">Sent Time:  ${tweet.getCreatedTime()}</h6>
